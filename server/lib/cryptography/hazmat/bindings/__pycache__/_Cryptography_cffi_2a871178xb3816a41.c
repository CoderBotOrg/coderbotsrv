...
static int _cffi_e_____D_enum____D_12(PyObject *lib)
{
  if ((kSecItemTypeUnknown) > 0 || (long)(kSecItemTypeUnknown) != 0L) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$12: ", "kSecItemTypeUnknown", buf, "0");
    return -1;
  }
  if ((kSecItemTypePrivateKey) <= 0 || (unsigned long)(kSecItemTypePrivateKey) != 1UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$12: ", "kSecItemTypePrivateKey", buf, "1");
    return -1;
  }
  if ((kSecItemTypePublicKey) <= 0 || (unsigned long)(kSecItemTypePublicKey) != 2UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$12: ", "kSecItemTypePublicKey", buf, "2");
    return -1;
  }
  if ((kSecItemTypeSessionKey) <= 0 || (unsigned long)(kSecItemTypeSessionKey) != 3UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$12: ", "kSecItemTypeSessionKey", buf, "3");
    return -1;
  }
  if ((kSecItemTypeCertificate) <= 0 || (unsigned long)(kSecItemTypeCertificate) != 4UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$12: ", "kSecItemTypeCertificate", buf, "4");
    return -1;
  }
  if ((kSecItemTypeAggregate) <= 0 || (unsigned long)(kSecItemTypeAggregate) != 5UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$12: ", "kSecItemTypeAggregate", buf, "5");
    return -1;
  }
...
static int _cffi_e_____D_enum____D_13(PyObject *lib)
{
  if ((kSecFormatUnknown) > 0 || (long)(kSecFormatUnknown) != 0L) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$13: ", "kSecFormatUnknown", buf, "0");
    return -1;
  }
  if ((kSecFormatOpenSSL) <= 0 || (unsigned long)(kSecFormatOpenSSL) != 1UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$13: ", "kSecFormatOpenSSL", buf, "1");
    return -1;
  }
  if ((kSecFormatSSH) <= 0 || (unsigned long)(kSecFormatSSH) != 2UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$13: ", "kSecFormatSSH", buf, "2");
    return -1;
  }
  if ((kSecFormatBSAFE) <= 0 || (unsigned long)(kSecFormatBSAFE) != 3UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$13: ", "kSecFormatBSAFE", buf, "3");
    return -1;
  }
  if ((kSecFormatRawKey) <= 0 || (unsigned long)(kSecFormatRawKey) != 4UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$13: ", "kSecFormatRawKey", buf, "4");
    return -1;
  }
  if ((kSecFormatWrappedPKCS8) <= 0 || (unsigned long)(kSecFormatWrappedPKCS8) != 5UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$13: ", "kSecFormatWrappedPKCS8", buf, "5");
    return -1;
  }
  if ((kSecFormatWrappedOpenSSL) <= 0 || (unsigned long)(kSecFormatWrappedOpenSSL) != 6UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$13: ", "kSecFormatWrappedOpenSSL", buf, "6");
    return -1;
  }
  if ((kSecFormatWrappedSSH) <= 0 || (unsigned long)(kSecFormatWrappedSSH) != 7UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$13: ", "kSecFormatWrappedSSH", buf, "7");
    return -1;
  }
  if ((kSecFormatWrappedLSH) <= 0 || (unsigned long)(kSecFormatWrappedLSH) != 8UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$13: ", "kSecFormatWrappedLSH", buf, "8");
    return -1;
  }
  if ((kSecFormatX509Cert) <= 0 || (unsigned long)(kSecFormatX509Cert) != 9UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$13: ", "kSecFormatX509Cert", buf, "9");
    return -1;
  }
  if ((kSecFormatPEMSequence) <= 0 || (unsigned long)(kSecFormatPEMSequence) != 10UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$13: ", "kSecFormatPEMSequence", buf, "10");
    return -1;
  }
  if ((kSecFormatPKCS7) <= 0 || (unsigned long)(kSecFormatPKCS7) != 11UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$13: ", "kSecFormatPKCS7", buf, "11");
    return -1;
  }
  if ((kSecFormatPKCS12) <= 0 || (unsigned long)(kSecFormatPKCS12) != 12UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$13: ", "kSecFormatPKCS12", buf, "12");
    return -1;
  }
  if ((kSecFormatNetscapeCertSequence) <= 0 || (unsigned long)(kSecFormatNetscapeCertSequence) != 13UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$13: ", "kSecFormatNetscapeCertSequence", buf, "13");
    return -1;
  }
  if ((kSecFormatSSHv2) <= 0 || (unsigned long)(kSecFormatSSHv2) != 14UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$13: ", "kSecFormatSSHv2", buf, "14");
    return -1;
  }
...
static int _cffi_e_____D_enum____D_14(PyObject *lib)
{
  if ((kSecKeyImportOnlyOne) <= 0 || (unsigned long)(kSecKeyImportOnlyOne) != 1UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$14: ", "kSecKeyImportOnlyOne", buf, "1");
    return -1;
  }
  if ((kSecKeySecurePassphrase) <= 0 || (unsigned long)(kSecKeySecurePassphrase) != 2UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$14: ", "kSecKeySecurePassphrase", buf, "2");
    return -1;
  }
  if ((kSecKeyNoAccessControl) <= 0 || (unsigned long)(kSecKeyNoAccessControl) != 4UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$14: ", "kSecKeyNoAccessControl", buf, "4");
    return -1;
  }
...
static struct PyModuleDef _cffi_module_def = {
  ...
  "_Cryptography_cffi_2a871178xb3816a41",
  NULL,
  -1,
  _cffi_methods,
  NULL, NULL, NULL, NULL
...
PyMODINIT_FUNC
PyInit__Cryptography_cffi_2a871178xb3816a41(void)
{
  PyObject *lib;
...
PyMODINIT_FUNC
init_Cryptography_cffi_2a871178xb3816a41(void)
{
  PyObject *lib;
  lib = Py_InitModule("_Cryptography_cffi_2a871178xb3816a41", _cffi_methods);
  if (lib == NULL)
    return;
  if (((void)lib,0) < 0 || _cffi_init() < 0)
    return;
